	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<form action="{{ (empty($data)) ? route('..setting.save') : route('..setting.update', $data->id)}}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="form-row">
						...
						<div class="form-group col-md-3" {{ (empty($data)) ? '' : 'hidden' }}>
							<label for="inputPassword4">type *</label>
							<input type="text" class="form-control" id="type" placeholder="type" name="type" value="{{ (empty($data)) ? '' : $data->type }}" >
						</div>
						<div class="form-group col-md-3">
